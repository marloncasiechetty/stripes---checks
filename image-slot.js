...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action is what lets a drag pan the crop, so it must NOT apply on a
    // published page: there it only swallows touch scrolling that happens to
    // start on an image, and the pan handlers are data-editable-gated anyway.
